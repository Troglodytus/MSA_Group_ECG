...
for fileID = fileIDs
    ...
    % ------ LOAD BINARY DATA --------------------------------------------------
    if any(dformat ~= 212)
        error('This script only applies binary formats of type 212.');
    end
...
net = patternnet([10, 15, 35, 35, 20, 10, 5, numOutputClasses],  'trainlm');
